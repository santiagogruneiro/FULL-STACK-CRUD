...
const baseUrl = process.env.REACT_APP_API_URL ? process.env.REACT_APP_API_URL + '/cars/' : 'https://pacific-sands-09601.herokuapp.com/api' + '/cars/'
...
export const carsHandler = { findAll, findById, create, remove, update }